package com.viancis.oauth2.oauth2.service.impl;
...
import com.viancis.oauth2.jackson2.mixin.AuditDeletedDateMixin;
import com.viancis.oauth2.jackson2.mixin.LongMixin;
import com.viancis.oauth2.jackson2.mixin.UserAuthorityMixin;
import com.viancis.oauth2.jackson2.mixin.UserPrincipalMixin;
import com.viancis.oauth2.jpa.audit.AuditDeletedDate;
import com.viancis.oauth2.jpa.entity.UserAuthority;
import com.viancis.oauth2.jpa.entity.User;
import com.viancis.oauth2.oauth2.OAuth2Util;
import com.viancis.oauth2.oauth2.entity.OAuth2AuthorizationEntity;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
	...
	public JpaOAuth2AuthorizationService(OAuth2AuthorizationRepository oauth2AuthorizationRepository,
		...
		this.objectMapper.addMixIn(User.class, UserPrincipalMixin.class);
