...
import com.viancis.oauth2.configuration.jose.Jwks;
import com.viancis.oauth2.oauth2.authentication.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.viancis.oauth2.oauth2.authentication.OAuth2ResourceOwnerPasswordAuthenticationProvider;
...
import com.viancis.oauth2.oauth2.customizer.jwt.impl.JwtCustomizerImpl;
import com.viancis.oauth2.oauth2.customizer.token.claims.OAuth2TokenClaimsCustomizer;
import com.viancis.oauth2.oauth2.customizer.token.claims.impl.OAuth2TokenClaimsCustomizerImpl;
import com.viancis.oauth2.oauth2.repository.OAuth2AuthorizationConsentRepository;
import com.viancis.oauth2.oauth2.repository.OAuth2AuthorizationRepository;
import com.viancis.oauth2.oauth2.service.impl.JpaOAuth2AuthorizationConsentService;
import com.viancis.oauth2.oauth2.service.impl.JpaOAuth2AuthorizationService;
	...
	public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		*/
		...
		Customizer <OAuth2AuthorizationServerConfigurer> authorizationServerConfigurerCustomizer = (authorizationServer) -> {
			...
			Customizer <OAuth2AuthorizationEndpointConfigurer> authorizationEndpointCustomizer = authorizationEndpoint -> authorizationEndpoint.consentPage(CUSTOM_CONSENT_PAGE_URI);
		...
		http.with(new FederatedIdentityConfigurer(), federatedIdentityConfigurerCustomizer);
