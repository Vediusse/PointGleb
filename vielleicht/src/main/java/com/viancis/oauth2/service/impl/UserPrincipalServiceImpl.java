package com.viancis.oauth2.service.impl;

import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

import com.viancis.oauth2.jpa.entity.User;
import com.viancis.oauth2.jpa.repository.UserPrincipalRepository;
...
public class UserPrincipalServiceImpl implements UserPrincipalService {
    ...
    public User loadUserByUsername(String username) {
    	...
    	User principal = userPrincipalRepository.getByUsername(username);
